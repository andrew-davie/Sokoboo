...
;    GNU General Public License for more details.
    ...
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_9", LINES_PER_CHAR
CHARACTERSHAPE_9
    REPEAT 3
        .byte %11101110,%10101010,%11101110,%00100010,%00100010,%11101110,%0000000 ;RGB
    REPEND

    ;--------------------------------------------------------------------------
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_9_MIRRORED", LINES_PER_CHAR
CHARACTERSHAPE_9_MIRRORED
    REPEAT 3
        .byte %01110111,%01010101,%01110111,%00010001,%00010001,%01110111,%0000000 ;RGB
    REPEND
