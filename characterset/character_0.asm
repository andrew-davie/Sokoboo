...
;    GNU General Public License for more details.
    ...
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_0", LINES_PER_CHAR
CHARACTERSHAPE_0
    REPEAT 3
    .byte %11101110,%10101010,%10101010,%10101010,%10101010,%11101110,%00000000 ;RGB
    REPEND

    ;--------------------------------------------------------------------------
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_0_MIRRORED", LINES_PER_CHAR
CHARACTERSHAPE_0_MIRRORED
    REPEAT 3
    .byte %01110111,%01010101,%01010101,%01010101,%01010101,%01110111,%00000000 ;RGB
    REPEND
