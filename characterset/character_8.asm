...
;    GNU General Public License for more details.
    ...
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_8", LINES_PER_CHAR
CHARACTERSHAPE_8
    REPEAT 3
        .byte %11101110,%10101010,%11101110,%10101010,%10101010,%11101110,%0000000 ;RGB
    REPEND

    ;--------------------------------------------------------------------------
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_8_MIRRORED", LINES_PER_CHAR
CHARACTERSHAPE_8_MIRRORED
    REPEAT 3
        .byte %01110111,%01010101,%01110111,%01010101,%01010101,%01110111,%0000000 ;RGB
    REPEND
