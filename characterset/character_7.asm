...
;    GNU General Public License for more details.
    ...
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_7", LINES_PER_CHAR
CHARACTERSHAPE_7
    REPEAT 3
        .byte %11101110,%00100010,%00100010,%00100010,%00100010,%00100010,%0000000 ;RGB
    REPEND

    ;--------------------------------------------------------------------------
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_7_MIRRORED", LINES_PER_CHAR
CHARACTERSHAPE_7_MIRRORED
    REPEAT 3
        .byte %01110111,%00010001,%00010001,%00010001,%00010001,%00010001,%0000000 ;RGB
    REPEND
