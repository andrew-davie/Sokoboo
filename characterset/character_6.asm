...
;    GNU General Public License for more details.
    ...
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_6", LINES_PER_CHAR
CHARACTERSHAPE_6
    REPEAT 3
        .byte %11101110,%00100010,%11101110,%10001000,%10001000,%10001000,%0000000 ;RGB
    REPEND

    ;--------------------------------------------------------------------------
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_6_MIRRORED", LINES_PER_CHAR
CHARACTERSHAPE_6_MIRRORED
    REPEAT 3
        .byte %01110111,%00010001,%01110111,%01000100,%01000100,%01000100,%0000000 ;RGB
    REPEND
