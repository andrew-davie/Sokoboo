...
;    GNU General Public License for more details.
    ...
    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_1", LINES_PER_CHAR
CHARACTERSHAPE_1
    REPEAT 3
        .byte %00100010,%00100010,%00100010,%00100010,%00100010,%00100010,0 ;RGB
    REPEND

    OPTIONAL_PAGEBREAK "CHARACTERSHAPE_1_MIRRORED", LINES_PER_CHAR
CHARACTERSHAPE_1_MIRRORED
    REPEAT 3
        .byte %01000100,%01000100,%01000100,%01000100,%01000100,%01000100,0 ;RGB
    REPEND
